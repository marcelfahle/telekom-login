  ...
  return (
    <div className="so-gehts">
      ...
      <ContentWrapper className="content-wrapper-full services__slider">
        <ul>
          <li>
            ...
            <img src="/static/images/services01.png" alt="Alle Telekom Dienste im Überblick" />
          </li>
        </ul>
        <div className="services__slider-controls">
          <a className="slider__controls--prev" href="#">
            <img src="/static/images/slider-trigger.svg" alt="Previous" />
          </a>
          <a className="slider__controls--next" href="#">
            <img src="/static/images/slider-trigger.svg" alt="Next" />
          </a>
        </div>
      </ContentWrapper>
      ...
      <ContentWrapper className="telekom-hilft">
        <img src="/static/images/logo-telekom-hilft.png" alt="Telekom Hilft Community" />
